...
<main class="container">
  <div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
    <div class="col-lg-12 px-0" style="text-align: center">
      <h1 class="display-4 fst-italic">Melhores Times de todos os Tempos</h1>
    </div>
  </div>
  ...
  <div class="row g-5">
    <div class="col-md-8">
      ...
      <article class="blog-post">
        ...
        <p>Prepare-se para explorar a história fascinante e os feitos gloriosos dos maiores clubes de futebol de todos os tempos. Ao longo dos anos, esses clubes não apenas dominaram os campos, mas também conquistaram corações e mentes de fãs ao redor do mundo. Neste artigo, mergulharemos nas conquistas lendárias e na aura de grandeza que envolve essas instituições do futebol.</p>
        
        <p>Continue lendo para descobrir como times como Barcelona, Real Madrid, e outros redefiniram os padrões de excelência e estabeleceram um legado inigualável no mundo do futebol.</p>
    </article>
